# Analise de Requisitos Arquiteturais
...
Identificacao de non-functional requirements como escalabilidade, performance e seguranca para guiar o design. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.

## Quando Aplicar

Obrigatorio quando o projeto declarar o pilar Architecture e depender deste comportamento para entregar valor, operar com seguranca ou reduzir risco.
...
- Pilar operacional: `docs/pillars/architecture/README.md`.
