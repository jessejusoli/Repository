...
Analise de decisoes como buy vs. build, sync vs. async, usando frameworks como ATAM ou QAW. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
