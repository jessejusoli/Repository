...
Criacao de diagramas C4 (Context, Containers, Components, Code) e ADRs (Architecture Decision Records). Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
