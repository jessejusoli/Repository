# Escolha de Padroes de Arquitetura
...
Selecao de estilos como monolithic, microservices, serverless ou event-driven baseado em trade-offs. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
