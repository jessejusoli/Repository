# Gerenciamento de Riscos Arquiteturais
...
Identificacao e mitigacao de riscos como vendor lock-in ou tech debt. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
