# Integracao de Sistemas Distribuidos
...
Estrategias para consistencia eventual, sagas ou two-phase commit em ambientes distribuidos. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
