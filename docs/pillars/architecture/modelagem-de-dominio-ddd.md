...
Aplicacao de Domain-Driven Design para mapear bounded contexts, aggregates e entities. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
