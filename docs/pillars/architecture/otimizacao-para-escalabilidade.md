# Otimizacao para Escalabilidade
...
Planejamento de partitioning, replication e caching em nivel arquitetural. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
