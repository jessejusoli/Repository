...
Implementacao de circuit breakers, retries e bulkheads para fault tolerance. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
