...
Implementacao de login, JWT, OAuth, roles e permissoes para controlar acesso a recursos. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
