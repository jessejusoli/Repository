...
Uso de Redis ou Memcached para armazenar dados frequentes e reduzir carga no banco de dados. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
