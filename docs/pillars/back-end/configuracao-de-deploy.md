...
Setup de ambientes (dev, staging, prod) com Docker, Kubernetes e variaveis de ambiente. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
