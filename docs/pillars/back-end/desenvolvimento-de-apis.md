...
Criacao de endpoints RESTful ou GraphQL para comunicacao com o front-end, incluindo rotas, metodos HTTP e documentacao com Swagger ou Postman. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.

## Quando Aplicar

Obrigatorio quando o projeto declarar o pilar Back-end e depender deste comportamento para entregar valor, operar com seguranca ou reduzir risco.
