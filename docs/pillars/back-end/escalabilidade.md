...
Design para horizontal scaling, sharding de DB e microservices para lidar com alto trafego. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
