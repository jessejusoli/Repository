...
Controle de estados de usuario com cookies, sessions ou tokens para apps stateful. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
