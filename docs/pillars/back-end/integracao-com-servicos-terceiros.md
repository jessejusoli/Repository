# Integracao com Servicos Terceiros
...
Conexao com APIs externas, como pagamentos (Stripe), autenticacao (Google Auth) ou storage (S3). Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
