...
Protecao contra SQL Injection, XSS, CSRF; hashing de senhas com bcrypt e validacao de entradas. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
