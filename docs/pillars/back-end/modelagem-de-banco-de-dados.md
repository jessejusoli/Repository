...
Design de esquemas, tabelas, relacionamentos e indices usando SQL (PostgreSQL, MySQL) ou NoSQL (MongoDB, Redis). Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
