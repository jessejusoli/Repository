...
Verificacao de inputs do usuario, schemas com Joi ou Pydantic para prevenir erros e injecoes. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
