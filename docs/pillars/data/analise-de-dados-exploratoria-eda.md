# Analise de Dados Exploratoria (EDA)
...
Tecnicas para investigar datasets, identificar padroes e outliers com pandas, NumPy ou R. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.

## Quando Aplicar

Obrigatorio quando o projeto declarar o pilar Dados e depender deste comportamento para entregar valor, operar com seguranca ou reduzir risco.
...
- Pilar operacional: `docs/pillars/data/README.md`.
