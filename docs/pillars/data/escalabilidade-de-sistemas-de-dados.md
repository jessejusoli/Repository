# Escalabilidade de Sistemas de Dados
...
Design para sharding, replication e auto-scaling em ambientes de big data. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
