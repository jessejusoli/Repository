...
Uso de frameworks como Hadoop, Spark ou Kafka para processar volumes massivos de dados em batch ou streaming. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
