...
Construcao de fluxos para treinamento, validacao e deploy de modelos com MLflow ou Kubeflow. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
