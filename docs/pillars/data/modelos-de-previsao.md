...
Implementacao de algoritmos como regressao, classificacao ou clustering com Scikit-learn ou TensorFlow. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
