...
Tuning de SQL ou NoSQL para performance, com indexing e partitioning em bancos como PostgreSQL ou MongoDB. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
