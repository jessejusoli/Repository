...
Extracao, transformacao e carga de dados de fontes variadas, usando ferramentas como Apache Airflow ou Talend. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
