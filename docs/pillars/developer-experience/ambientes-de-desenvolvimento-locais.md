...
Docker Compose e dev containers para setups identicos ao prod. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
