...
Uso de AI (GitHub Copilot) e scripts para boilerplate, refatoracao e code reviews. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
