...
Pull requests leves, code reviews automatizados e pair programming. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
