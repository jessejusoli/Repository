...
Configuracao de thresholds para disparar alertas via Slack, PagerDuty ou email em caso de falhas. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
