...
Calculo de DORA metrics (deployment frequency, lead time) para medir eficiencia e produtividade (link com DevEx). Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
