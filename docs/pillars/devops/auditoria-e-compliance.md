...
Logs de acoes no pipeline para rastreabilidade, atendendo normas como SOC2 ou ISO 27001. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
