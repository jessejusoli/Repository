...
Scripts para compilar codigo, gerar artefatos e gerenciar dependencias com ferramentas como Maven, Gradle ou npm. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
