# Backup e Recuperacao Automatizados
...
Scripts para snapshots e restores de dados e configs em nuvens como AWS Backup. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
