...
Uso de Git workflows (GitFlow, trunk-based) para merges, reviews e branching strategies. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
