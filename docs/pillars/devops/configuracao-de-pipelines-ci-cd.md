# Configuracao de Pipelines CI/CD
...
Criacao de fluxos automatizados para build, test e deploy, usando ferramentas como GitHub Actions, GitLab CI ou Jenkins. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.

## Quando Aplicar

Obrigatorio quando o projeto declarar o pilar DevOps e depender deste comportamento para entregar valor, operar com seguranca ou reduzir risco.
