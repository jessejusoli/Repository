...
Estrategias como blue-green deployment ou canary releases para atualizar aplicacoes sem downtime. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
