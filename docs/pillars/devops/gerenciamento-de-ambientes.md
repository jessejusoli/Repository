...
Criacao de ambientes isolados (dev, staging, prod) com promocoes controladas e rollbacks. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
