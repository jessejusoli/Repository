...
Uso de ferramentas como Ansible, Puppet ou Chef para provisionar e configurar ambientes de forma consistente. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
