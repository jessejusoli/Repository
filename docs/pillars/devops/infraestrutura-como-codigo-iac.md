...
Definicao de infra via codigo com Terraform ou Pulumi para versionamento e automacao. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
