# Integracao com Ferramentas de Colaboracao
...
Hooks para Jira, Trello ou Slack para updates automaticos de status de builds. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
