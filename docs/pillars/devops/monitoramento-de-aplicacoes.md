...
Setup de metricas, traces e logs com Prometheus, Grafana ou New Relic para saude do sistema em tempo real. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
