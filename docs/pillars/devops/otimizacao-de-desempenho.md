...
Profiling e tuning de pipelines para reduzir tempos de build/deploy com caching e parallelizacao. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
