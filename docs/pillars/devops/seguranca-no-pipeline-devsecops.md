# Seguranca no Pipeline (DevSecOps)
...
Integracao de scans de vulnerabilidades (SAST, DAST) com SonarQube ou Snyk em etapas de CI. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
