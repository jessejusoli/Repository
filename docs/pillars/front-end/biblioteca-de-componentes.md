...
Desenvolvimento de componentes reutilizaveis, como cards, modais ou forms padronizados (alinhado com component-based architecture de "Clean Code"). Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
