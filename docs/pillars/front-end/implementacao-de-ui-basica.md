...
Criacao de elementos visuais fundamentais, como botoes, inputs e layouts iniciais usando HTML/CSS/JS puro ou frameworks. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.

## Quando Aplicar

Obrigatorio quando o projeto declarar o pilar Front-end e depender deste comportamento para entregar valor, operar com seguranca ou reduzir risco.
