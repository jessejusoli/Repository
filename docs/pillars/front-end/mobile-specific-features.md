...
Para apps, handling de gestos, push notifications e integracao com hardware (camera, GPS). Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
