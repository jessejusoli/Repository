...
Tecnicas como lazy loading, code splitting e memoization para reduzir tempo de carregamento. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
