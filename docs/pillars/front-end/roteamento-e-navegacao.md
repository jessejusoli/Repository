...
Configuracao de rotas para paginas multiplas, usando React Router ou similares. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
