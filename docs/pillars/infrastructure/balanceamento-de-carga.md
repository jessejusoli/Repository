...
Setup de load balancers (ELB, ALB) para distribuir trafego e garantir alta disponibilidade. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
