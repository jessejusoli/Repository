...
Empacotamento de aplicacoes em containers com Docker, incluindo criacao de images e gerenciamento de registries como ECR. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
