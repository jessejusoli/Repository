...
Provisionamento e gerenciamento de DBs gerenciados como RDS, DynamoDB ou Cloud SQL, incluindo replicacao e sharding. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
