...
Configuracao de Content Delivery Networks como CloudFront ou Akamai para cache e entrega rapida de conteudo estatico. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
