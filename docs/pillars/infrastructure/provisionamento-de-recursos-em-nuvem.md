...
Configuracao inicial de contas e projetos em provedores como AWS, GCP ou Azure, incluindo setup de regioes e zonas de disponibilidade. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
