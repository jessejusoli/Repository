...
Implementacao de storage persistente, como S3 para objetos, EBS para blocos ou Cloud Storage para arquivos, com gerenciamento de backups. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
