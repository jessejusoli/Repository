# Alinhamento de TI com Estrategia de Negocio
...
Integracao de infraestrutura e ferramentas de dev aos objetivos organizacionais, priorizando recursos para transformacao digital. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.

## Quando Aplicar

Obrigatorio quando o projeto declarar o pilar IT Governance e depender deste comportamento para entregar valor, operar com seguranca ou reduzir risco.
