...
Desenvolvimento de perfis ficticios representando usuarios tipicos, baseados em pesquisa, para guiar decisoes de design. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
