...
Coleta de dados sobre necessidades, comportamentos e dores dos usuarios via entrevistas, surveys ou analise de dados com ferramentas como Google Forms ou Typeform. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.

## Quando Aplicar

Obrigatorio quando o projeto declarar o pilar Produto/UX e depender deste comportamento para entregar valor, operar com seguranca ou reduzir risco.
...
- Pilar operacional: `docs/pillars/product-ux/README.md`.
