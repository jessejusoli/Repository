...
Analise de quanto do codigo e exercitado pelos testes, com metricas de branch e line coverage via Istanbul ou JaCoCo. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
