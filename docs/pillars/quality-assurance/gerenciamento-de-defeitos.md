...
Uso de ferramentas como Jira ou Bugzilla para rastrear, priorizar e resolver bugs reportados. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
