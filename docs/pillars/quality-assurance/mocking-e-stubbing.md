...
Criacao de simulacoes para dependencias externas, como APIs ou DBs, com ferramentas como WireMock ou Sinon. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
