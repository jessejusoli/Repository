# Testes de Seguranca Basicos (AppSec)
...
Identificacao de vulnerabilidades comuns, complementando o time de Security com scans iniciais. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
