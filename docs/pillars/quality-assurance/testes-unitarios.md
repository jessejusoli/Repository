...
Verificacao de componentes individuais do codigo, como funcoes ou classes, usando frameworks como Jest ou JUnit. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
