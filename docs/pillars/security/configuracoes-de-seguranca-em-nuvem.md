# Configuracoes de Seguranca em Nuvem
...
Hardening de ambientes com IAM policies, encryption e least privilege em AWS/GCP/Azure. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
