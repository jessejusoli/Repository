...
Uso de protocolos como TLS/SSL para proteger comunicacoes entre cliente e servidor. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
