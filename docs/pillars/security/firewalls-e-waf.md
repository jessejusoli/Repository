...
Regras de Web Application Firewall (ModSecurity) para filtrar requests suspeitos e bloquear exploits. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
