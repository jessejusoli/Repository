...
Definicao de papeis e permissoes (RBAC/ABAC) para controlar acesso a recursos especificos. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
