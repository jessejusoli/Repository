# Praticas de Codificacao Segura
...
Adocao de guidelines OWASP para evitar erros comuns como buffer overflows ou race conditions. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
