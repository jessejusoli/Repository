...
Validacoes e prepared statements para prevenir SQL Injection, XSS ou outras injecoes de codigo. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
