# Scans de Vulnerabilidades Dinamicas (DAST)
...
Testes em runtime com ferramentas como OWASP ZAP para simular ataques em aplicacoes rodando. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.

## Quando Aplicar

Obrigatorio quando o projeto declarar o pilar Seguranca e depender deste comportamento para entregar valor, operar com seguranca ou reduzir risco.
...
- Pilar operacional: `docs/pillars/security/README.md`.
