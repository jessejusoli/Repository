# Scans de Vulnerabilidades Estaticas (SAST)
...
Analise de codigo fonte com ferramentas como SonarQube para detectar falhas precocemente. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
