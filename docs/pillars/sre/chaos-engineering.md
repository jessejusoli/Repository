...
Testes controlados de falhas (ex.: com Chaos Monkey) para validar resiliencia. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
