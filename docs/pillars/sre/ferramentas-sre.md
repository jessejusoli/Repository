...
Uso de PagerDuty, Incident.io ou Google Stackdriver para ops. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
