...
Setup de golden signals (latency, traffic, errors, saturation) com Prometheus ou Datadog. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
