# Otimizacao de Custos com Reliability
...
Balanceamento de over-provisioning vs. efficiency (link com Sustainability). Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
