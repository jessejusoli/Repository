# Performance Tuning em Producao
...
Analise de bottlenecks com tracing (Jaeger) e profiling. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
