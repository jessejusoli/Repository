...
Agendar jobs pesados em horarios de energia limpa (ex.: Green Software Foundation tools). Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
