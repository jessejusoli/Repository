# Design Sustentavel no Front-end
...
Dark mode por default, imagens otimizadas e menos animacoes. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
