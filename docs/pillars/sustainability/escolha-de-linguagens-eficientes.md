...
Preferir Rust/Go sobre Python quando possivel para menos consumo. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
