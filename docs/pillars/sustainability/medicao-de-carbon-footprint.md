...
Uso de ferramentas como Cloud Carbon Footprint ou Green Algorithms para rastrear emissoes. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.

## Quando Aplicar

Obrigatorio quando o projeto declarar o pilar Sustainability/Green Software e depender deste comportamento para entregar valor, operar com seguranca ou reduzir risco.
