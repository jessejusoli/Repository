# Otimizacao de Codigo Eficiente
...
Tecnicas para menos CPU/GPU, como algoritmos leves e caching agressivo. Este item garante que a decisao seja visivel, revisavel e aplicavel em qualquer linguagem, stack ou ambiente.
