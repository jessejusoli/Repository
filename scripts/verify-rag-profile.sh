...
if [[ -f "$PROFILE" ]]; then
  ...
  for source in "AGENTS.md" "README.md" "references.md" "catalog/" "contracts/" "docs/" "docs/standards/" "docs/forge/" "docs/templates/lifecycle/" "catalog/standards.yml" "catalog/project-lifecycle.yml" "catalog/project-artifacts.yml"; do
  ...
  grep -q '    - catalog/project-lifecycle.yml' "$PROFILE" || fail "dataset catalog/project-lifecycle.yml ausente"
  grep -q '    - catalog/project-artifacts.yml' "$PROFILE" || fail "dataset catalog/project-artifacts.yml ausente"
