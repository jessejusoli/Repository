...
required_files=(
  ...
  "docs/templates/lifecycle/README.md"
)
...
grep -q '^schema_version: 1$' "$ROOT_DIR/catalog/project-lifecycle.yml" || fail "catalog/project-lifecycle.yml sem schema_version 1"
grep -q '^schema_version: 1$' "$ROOT_DIR/catalog/project-artifacts.yml" || fail "catalog/project-artifacts.yml sem schema_version 1"
